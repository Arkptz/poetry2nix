  ...
  (
    final: prev:
      ...
      in
      {
        ...
        argon2-cffi =
          if (lib.versionAtLeast prev.argon2-cffi.version "21.2.0")
          then
            addBuildSystem'
              {
                inherit final;
        ...
        docutils =
          if lib.versionOlder prev.docutils.version "0.16" && lib.versionAtLeast prev.setuptools.version "60"
          then
            (
            ...
            prev.jsonschema.overridePythonAttrs
              (old: {
                ...
                postPatch =
                  old.postPatch
                    or ""
                  + lib.optionalString (!(old.src.isWheel or false) && (lib.versionAtLeast prev.jsonschema.version "4.18.0")) ''
        ...
        molecule =
          if lib.versionOlder prev.molecule.version "3.0.0"
          then
        ...
        notebook =
          if (lib.versionAtLeast prev.notebook.version "7.0.0")
          then
        ...
        pydantic-core = bootstrappingBase.pydantic-core;
        ...
        pyarrow =
          if (!prev.pyarrow.src.isWheel or false) && lib.versionAtLeast prev.pyarrow.version "0.16.0"
          then
        ...
        sniffio = bootstrappingBase.sniffio;
        ...
        watchfiles = bootstrappingBase.watchfiles;
        ...
        minimal-snowplow-tracker =
          prev.minimal-snowplow-tracker.overridePythonAttrs
            (
              old: {
